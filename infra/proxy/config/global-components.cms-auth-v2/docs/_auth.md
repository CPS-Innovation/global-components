...
| Append cookie    | `[proxy or CMS]/polaris` | `*`                                                                 | 1) Convert cookies to query 2) add is-proxy-session                                                                |
| Receiving cookie | `proxy/init/`            | `*,correlation,is-proxy-session,cookie`                             | 1) Switch out of IE mode; 2) Get and verify modern token 3) add correlation-id                                     |
