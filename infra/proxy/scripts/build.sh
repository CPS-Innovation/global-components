...
cp "$PROXY_DIR/config/global-components.navigate-cms/global-components.navigate-cms.conf" "$DIST_DIR/global-components.navigate-cms.conf.template"
...
mv "$DIST_DIR/global-components.navigate-cms/global-components.navigate-cms.js" "$DIST_DIR/global-components.navigate-cms.js"
...
rmdir "$DIST_DIR/global-components.navigate-cms" 2>/dev/null || true
