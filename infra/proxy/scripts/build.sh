...
cp "$PROXY_DIR/config/global-components/global-components.conf.template" "$DIST_DIR/global-components.conf.template"
...
mv "$DIST_DIR/global-components/global-components.js" "$DIST_DIR/global-components.js"
...
rmdir "$DIST_DIR/global-components" 2>/dev/null || true
