...
cp -r ./packages/cps-global-components/dist/global-components.js* ./apps/harness-html/src/assets/
cp ./packages/cps-global-components/src/config.* ./apps/harness-html/src/assets/
