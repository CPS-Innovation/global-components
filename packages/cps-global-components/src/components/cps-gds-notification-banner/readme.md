...
| `pinned`            | `pinned`              | Pin the banner to the bottom of the viewport instead of letting it sit in the document flow. Matches the UCD prototype's app-notification-banner-pinned.                                                                                                                                                                                                                | `boolean`                | `false`                             |
