...
| `dcfContextsToUseEventNavigation` | --                |             | `undefined \| { contexts: string; data: string; waitingBehaviour: "disabled" \| "default-dcf" \| "default-no-dcf"; paramsToAddToQuery?: Record<string, string \| null> \| undefined; }` | `undefined` |
