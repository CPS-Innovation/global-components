...
describe("FEATURE_FLAGS", () => {
  ...
  describe("shouldShowMenu", () => {
    it("should return true when context is not found but standard conditions are met", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: true, groups: ["admin-group"] } as any,
        context: { found: false },
      };
    ...
    it("should return true when showMenuOverride is 'always-show-menu'", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: false, FEATURE_FLAG_ENABLE_MENU_GROUP: "" } as any,
        auth: { isAuthed: false, groups: [] } as any,
    ...
    it("should return true when all standard conditions are met", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: true, groups: ["admin-group", "other-group"] } as any,
    ...
    it("should return false when SHOW_MENU is false", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: false, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: true, groups: ["admin-group"] } as any,
        context: { found: true } as any,
      };
    ...
    it("should return false when FEATURE_FLAG_ENABLE_MENU_GROUP is not set", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "" } as any,
        auth: { isAuthed: true, groups: ["admin-group"] } as any,
        context: { found: true } as any,
      };
    ...
    it("should return false when user is not authenticated", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: false, groups: ["admin-group"] } as any,
        context: { found: true } as any,
      };
    ...
    it("should return false when user is not in the required group", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: true, groups: ["other-group", "another-group"] } as any,
        context: { found: true } as any,
      };
    ...
    it("should return false when user has no groups", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: true, groups: [] } as any,
        context: { found: true } as any,
      };
    ...
    it("should return true when user is in one of multiple groups including the required group", () => {
      const state: Pick<KnownState, "config" | "auth" | "context"> = {
        config: { SHOW_MENU: true, FEATURE_FLAG_ENABLE_MENU_GROUP: "admin-group" } as any,
        auth: { isAuthed: true, groups: ["user-group", "admin-group", "editor-group"] } as any,
        context: { found: true } as any,
      };
