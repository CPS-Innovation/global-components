...
describe("handleMsalEnsureAd", () => {
  ...
  it("returns 'silent-success' when acquireTokenSilent resolves; never calls loginRedirect", async () => {
    ...
    expect(acquireTokenSilent).toHaveBeenCalledWith({ scopes: ["User.Read"] });
