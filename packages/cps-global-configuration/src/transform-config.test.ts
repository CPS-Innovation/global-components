...
describe("transformConfig", () => {
  ...
  const input: ConfigStorage = {
    ...
    expect(result.CONTEXTS[0].path).toBe("/first");
    expect(result.CONTEXTS[0].msalRedirectUrl).toBe("https://redirect.example.com");
    ...
    expect(result.CONTEXTS[1].path).toBe("/second");
    expect(result.CONTEXTS[1].msalRedirectUrl).toBe("https://redirect.example.com");
  ...
  const input: ConfigStorage = {
    ...
    expect(result.CONTEXTS[0].path).toBe("/first");
    expect(result.CONTEXTS[0].msalRedirectUrl).toBe("https://child.example.com");
    expect(result.CONTEXTS[0].applyOutSystemsShim).toBe(true);
  });
  ...
  const input: ConfigStorage = {
    ...
    expect(result.CONTEXTS.length).toBe(4);
    expect(result.CONTEXTS[0].path).toBe("/first");
    expect(result.CONTEXTS[0].msalRedirectUrl).toBe("https://group1.example.com");
    expect(result.CONTEXTS[1].path).toBe("/second");
    expect(result.CONTEXTS[1].msalRedirectUrl).toBe("https://group1.example.com");
    expect(result.CONTEXTS[2].path).toBe("/third");
    expect(result.CONTEXTS[2].msalRedirectUrl).toBe("https://group2.example.com");
    expect(result.CONTEXTS[3].path).toBe("/fourth");
    expect(result.CONTEXTS[3].msalRedirectUrl).toBe("https://group2.example.com");
  });
  ...
  const input: ConfigStorage = {
    ...
    expect(result.AD_TENANT_AUTHORITY).toBe("https://login.microsoftonline.com/tenant-id");
