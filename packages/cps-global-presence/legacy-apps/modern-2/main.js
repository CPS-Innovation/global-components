/* modern-2/main.js — boot and wiring. MODERN/DCF ONLY.
 *
 ...
 * the two implementations can be compared with only the presentation as a
 * variable. Only one of them is deployed — see build.sh and deploy.local.sh.
 *
 ...
 *   modern-2/bar.js          what that looks like on screen
...
function draw() {
  // Through CCPPeople rather than roster.people(): the indicator names applications
