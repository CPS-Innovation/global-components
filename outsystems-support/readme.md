...
| script-src/child-src     | `polaris-qa-notprod.cps.gov.uk`                               | Retrieve global components script             |
| connect-src              | `polaris-qa-notprod.cps.gov.uk`                               | Retrieve environment-specific config file     |
